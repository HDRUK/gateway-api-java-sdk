...
public class AuthenticationRequest {
  ...
  public AuthenticationRequest email(@javax.annotation.Nullable String email) {
    this.email = email;
    return this;
  }
  ...
  public AuthenticationRequest password(@javax.annotation.Nullable String password) {
  ...
  public AuthenticationRequest provider(@javax.annotation.Nullable String provider) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.email, authenticationRequest.email) &&
        ...
        Objects.equals(this.provider, authenticationRequest.provider);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuthenticationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AuthenticationRequest is not found in the empty JSON string", AuthenticationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AuthenticationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AuthenticationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
