...
public class SearchCollectionsRequest {
  ...
  public SearchCollectionsRequest query(@javax.annotation.Nullable String query) {
    this.query = query;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.query, searchCollectionsRequest.query);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchCollectionsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SearchCollectionsRequest is not found in the empty JSON string", SearchCollectionsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SearchCollectionsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SearchCollectionsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
