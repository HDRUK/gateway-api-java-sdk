...
public class Collection {
  ...
  public Collection id(@javax.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public Collection imageLink(@javax.annotation.Nullable String imageLink) {
  ...
  public Collection enabled(@javax.annotation.Nullable Boolean enabled) {
  ...
  public Collection keywords(@javax.annotation.Nullable String keywords) {
  ...
  public Collection _public(@javax.annotation.Nullable Boolean _public) {
  ...
  public Collection counter(@javax.annotation.Nullable Integer counter) {
  ...
  public Collection status(@javax.annotation.Nullable StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public Collection teamId(@javax.annotation.Nullable Integer teamId) {
    this.teamId = teamId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, collection.id) &&
        ...
        Objects.equals(this._public, collection._public) &&
        Objects.equals(this.counter, collection.counter) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, description, imageLink, enabled, keywords, _public, counter, status, teamId, createdAt, updatedAt);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "name", "description", "image_link", "enabled", "keywords", "public", "counter", "status", "team_id", "created_at", "updated_at"));
