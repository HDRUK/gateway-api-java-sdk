...
public class CreateCollectionsRequest {
  ...
  public CreateCollectionsRequest name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateCollectionsRequest description(@javax.annotation.Nullable String description) {
  ...
  public CreateCollectionsRequest imageLink(@javax.annotation.Nullable String imageLink) {
  ...
  public CreateCollectionsRequest enabled(@javax.annotation.Nullable Boolean enabled) {
  ...
  public CreateCollectionsRequest keywords(@javax.annotation.Nullable List<String> keywords) {
    this.keywords = keywords;
    return this;
  }

  public CreateCollectionsRequest addKeywordsItem(String keywordsItem) {
  ...
  public CreateCollectionsRequest collaborators(@javax.annotation.Nullable List<Integer> collaborators) {
    this.collaborators = collaborators;
    return this;
  }

  public CreateCollectionsRequest addCollaboratorsItem(Integer collaboratorsItem) {
  ...
  public CreateCollectionsRequest _public(@javax.annotation.Nullable Boolean _public) {
  ...
  public boolean equals(Object o) {
    ...
    CreateCollectionsRequest createCollectionsRequest = (CreateCollectionsRequest) o;
    return Objects.equals(this.name, createCollectionsRequest.name) &&
        Objects.equals(this.description, createCollectionsRequest.description) &&
        Objects.equals(this.imageLink, createCollectionsRequest.imageLink) &&
        Objects.equals(this.enabled, createCollectionsRequest.enabled) &&
        Objects.equals(this.keywords, createCollectionsRequest.keywords) &&
        Objects.equals(this.datasets, createCollectionsRequest.datasets) &&
        Objects.equals(this.tools, createCollectionsRequest.tools) &&
        Objects.equals(this.dur, createCollectionsRequest.dur) &&
        Objects.equals(this.publications, createCollectionsRequest.publications) &&
        Objects.equals(this.collaborators, createCollectionsRequest.collaborators) &&
        Objects.equals(this._public, createCollectionsRequest._public);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, description, imageLink, enabled, keywords, datasets, tools, dur, publications, collaborators, _public);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "description", "image_link", "enabled", "keywords", "datasets", "tools", "dur", "publications", "collaborators", "public"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateCollectionsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateCollectionsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateCollectionsRequest is not found in the empty JSON string", CreateCollectionsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateCollectionsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateCollectionsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateCollectionsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateCollectionsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateCollectionsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateCollectionsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateCollectionsRequest>() {
           @Override
           public void write(JsonWriter out, CreateCollectionsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateCollectionsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateCollectionsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateCollectionsRequest
   * @throws IOException if the JSON string is invalid with respect to CreateCollectionsRequest
   */
  public static CreateCollectionsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateCollectionsRequest.class);
  }

  /**
   * Convert an instance of CreateCollectionsRequest to an JSON string
   *
   * @return JSON string
   */
