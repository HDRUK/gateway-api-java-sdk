...
import uk.ac.hdruk.gatewayapi.auth.Authentication;
import uk.ac.hdruk.gatewayapi.auth.HttpBasicAuth;
import uk.ac.hdruk.gatewayapi.auth.HttpBearerAuth;
import uk.ac.hdruk.gatewayapi.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    protected void init() {
        ...
        setUserAgent("OpenAPI-Generator/0.0.0-test5/java");
     ...
     * @return a {@link uk.ac.hdruk.gatewayapi.ApiClient} object
     */
    ...
    */
     ...
     * @throws uk.ac.hdruk.gatewayapi.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws uk.ac.hdruk.gatewayapi.ApiException If fail to serialize the given object
     */
     ...
     * @throws uk.ac.hdruk.gatewayapi.ApiException If fail to read file content from response and write to disk
     ...
     * @throws uk.ac.hdruk.gatewayapi.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws uk.ac.hdruk.gatewayapi.ApiException If the response has an unsuccessful status code or
     ...
     * @throws uk.ac.hdruk.gatewayapi.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws uk.ac.hdruk.gatewayapi.ApiException If fails to update the parameters
     */
     ...
     * @throws uk.ac.hdruk.gatewayapi.ApiException If fail to serialize the request body object into a string
     */
