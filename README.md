...
HDRUK Gateway API
- API version: 2.0.0
  - Build date: 2026-08-05T08:39:33.604456851Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "uk.ac.hdruk.gatewayapi:gateway-api-sdk:0.0.0-test6"
  }
```
...
* `target/gateway-api-sdk-0.0.0-test6.jar`
* `target/lib/*.jar`
