...
> DeleteApplications200Response deleteDarApplicationFiles(id, fileId)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      DeleteApplications200Response result = apiInstance.deleteDarApplicationFiles(id, fileId);
...
> DeleteApplications200Response deleteDarApplications(id)
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer id = 1; // Integer | DAR application id
    try {
      DeleteApplications200Response result = apiInstance.deleteDarApplications(id);
      System.out.println(result);
    } catch (ApiException e) {
