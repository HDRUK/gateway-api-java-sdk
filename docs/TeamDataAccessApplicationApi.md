...
> FetchTeamDarApplicationHeader200Response fetchTeamDarApplicationHeader(teamId, id)
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer id = 1; // Integer | DAR application id
    try {
      FetchTeamDarApplicationHeader200Response result = apiInstance.fetchTeamDarApplicationHeader(teamId, id);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TeamDataAccessApplicationApi#fetchTeamDarApplicationHeader");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
